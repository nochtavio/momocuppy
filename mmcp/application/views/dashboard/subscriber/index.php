  ...
  <div class="col-lg-12">
    <form class="form-inline form_filter" role="form">
      <div class="form-group">
        <label class="sr-only" for="txt_email">Subscriber</label>
        <input type="text" class="form-control" id="txt_email" placeholder="Email">
      </div>
      <div class="form-group">
        <select class="form-control" id="sel_order">
          <option value="-1">Sort By Email A-Z</option>
          <option value="1">Sort By Email Z-A</option>
      ...
      <button id="btn_add" type="button" class="btn btn-primary pull-right">Add Email</button>
