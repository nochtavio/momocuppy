...
class order extends CI_Controller {
  ...
  function show_object() {
    ...
    if ($checkadmin > 0) {
      ...
      $totalrow = $this->model_order->get_object(0, $email, $street_address, $zip_code, $country, $city, $order_no, $resi_no, $status, $order)->num_rows();
      ...
      if ($totalrow > 0) {
        $query = $this->model_order->get_object(0, $email, $street_address, $zip_code, $country, $city, $order_no, $resi_no, $status, $order, $limit, $size)->result();
        $temp = 0;
