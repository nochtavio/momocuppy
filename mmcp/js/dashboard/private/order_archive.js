$(document).ready(function () {
  ...
  getObject = function (page)
  {
    ...
    //End Filter
    $.ajax({
      url: baseurl + 'dashboard/order_archive/show_object',
      type: 'POST',
      data:
        {
          page: page,
  ...
  editObject = function ()
  {
    ...
    $.ajax({
      url: baseurl + 'dashboard/order_archive/edit_object',
      type: 'POST',
      data:
        {
          id: id,
  ...
  {
    $.ajax({
      url: baseurl + 'dashboard/order_archive/set_archive',
      type: 'POST',
      data:
        {
          id: id
  ...
  setEdit = function ()
  {
    ...
    $.each(id, function (x, val) {
      ...
      $(document).on('click', '#btn_edit' + val, function () {
        $.ajax({
          url: baseurl + 'dashboard/order_archive/get_object',
          type: 'POST',
          data:
            {
              id: val
